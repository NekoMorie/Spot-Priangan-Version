...
const nt_header = document.createElement('h4');
...
const nt_list = document.createElement('div');
nt_list.classList.add('notif-tugas-list');
nt_list.style.width = '100%';
nt_list.style.height = '35vh';
...
const nt_space = document.createElement('div');
...
sidebar.appendChild(webhookUrlInput);
sidebar.appendChild(sendNotificationButton);
sidebar.appendChild(phoneNumberInput);
